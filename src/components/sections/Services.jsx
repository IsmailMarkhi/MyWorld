...
const services = [
  {
    ...
    desc: "Complete websites built with clean structure, responsive layouts, polished pages, and a professional user experience.",
    icon: FaGlobe,
  ...
  },
  {
    id: 1,
    title: "Landing Pages",
    desc: "Focused pages designed to explain your offer clearly, build trust, and guide visitors toward action.",
    icon: FaRocket,
  ...
  },
  {
    ...
    desc: "Modern React and Tailwind interfaces built with reusable components, responsive behavior, and clean UI systems.",
    icon: FaLaptopCode,
    tag: "React + Tailwind",
    type: "Frontend",
    status: "Available",
  ...
  },
  {
    ...
    desc: "Laravel and PHP backend systems with organized logic, API structure, authentication flows, and maintainable architecture.",
    icon: FaServer,
    tag: "Laravel Systems",
    type: "Backend",
    status: "Available",
  ...
  },
  {
    ...
    type: "Data Layer",
    status: "Available",
    color: "from-green-100 via-white to-emerald-100",
  },
  {
    id: 5,
    title: "Bug Fixing",
  ...
  },
  {
    ...
    desc: "Visual refinement for spacing, hierarchy, consistency, mobile behavior, and a more premium product feel.",
    icon: FaPaintBrush,
    tag: "Polished UI",
    type: "Design Upgrade",
    status: "Available",
    color: "from-pink-100 via-white to-fuchsia-100",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    type: "Optimization",
    status: "Available",
    color: "from-slate-100 via-white to-zinc-100",
  },
];
...
const ServiceCard = memo(({ service }) => {
  ...
  return (
    <motion.article
      ...
      className={`
        group relative overflow-hidden rounded-[38px]
        border border-white/70 bg-white/70 p-[1px]
        shadow-[0_22px_70px_rgba(24,24,27,0.08)]
        backdrop-blur-xl transition-all duration-500
        hover:-translate-y-2 hover:shadow-[0_34px_120px_rgba(88,28,135,0.20)]
        ${isMain ? "lg:col-span-2" : ""}
      `}
    >
      <div
        className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-80 transition duration-500 group-hover:opacity-100`}
      />

      <div className="absolute -right-20 -top-20 h-44 w-44 rounded-full bg-purple-300/20 blur-3xl transition duration-500 group-hover:bg-purple-300/35" />

      <div className="absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-purple-500/70 to-transparent" />

      <div className="relative z-10 flex h-full flex-col justify-between rounded-[37px] border border-zinc-200/70 bg-white/85 p-6 backdrop-blur-xl sm:p-7">
        <div>
          <div className="mb-6 flex items-start justify-between gap-4">
            <div className="flex h-[52px] w-[52px] items-center justify-center rounded-2xl border border-zinc-200 bg-white text-purple-700 shadow-[0_10px_28px_rgba(24,24,27,0.08)] transition duration-300 group-hover:scale-105 group-hover:shadow-[0_14px_35px_rgba(88,28,135,0.16)]">
              {isMain ? <Sparkles size={21} /> : <Icon size={21} />}
            </div>
        ...
        <div className="mt-7 flex flex-wrap gap-2">
          <span className="rounded-full border border-zinc-200 bg-white/90 px-3 py-1.5 text-[11px] font-bold text-zinc-700 shadow-sm">
            {service.tag}
          </span>
        ...
        <div className="mt-8 flex items-center justify-between border-t border-zinc-200/80 pt-5">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 rounded-2xl border border-zinc-950 bg-zinc-950 px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:-translate-y-1 hover:bg-purple-700"
      ...
      <Container>
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            ...
            <div className="mx-auto mt-10 grid max-w-3xl gap-3 sm:grid-cols-3">
              {stats.map((item) => (
                <div
                  key={item.label}
                  className="rounded-[28px] border border-zinc-200/80 bg-white/80 p-5 shadow-[0_12px_35px_rgba(24,24,27,0.08)] backdrop-blur"
                >
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            custom={0.1}
            className="mx-auto mb-16 overflow-hidden rounded-[38px] border border-white/70 bg-white/70 p-[1px] shadow-[0_22px_70px_rgba(24,24,27,0.08)] backdrop-blur-xl"
          >
            <div className="relative rounded-[37px] border border-zinc-200/70 bg-white/85 p-7 backdrop-blur-xl lg:p-9">
              <div className="absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-purple-500/70 to-transparent" />
              ...
              <div className="grid gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center">
                <div>
                  <p className="mb-3 inline-flex items-center gap-2 rounded-full border border-purple-100 bg-purple-50 px-3 py-1 text-[11px] font-black uppercase tracking-[0.18em] text-purple-700">
                    <ShieldCheck size={13} />
                    Service Standard
                  </p>

                  <h3 className="text-3xl font-black tracking-[-0.04em] text-zinc-950 sm:text-4xl">
                    Clean execution from idea to usable web product.
                  </h3>

                  <p className="mt-4 max-w-2xl text-sm leading-7 text-zinc-600 sm:text-base">
                    I focus on websites and web systems that are clear to use,
                    responsive on all devices, visually polished, and organized
