      ...
      <Container size="wide">
        ...
        <div className="relative mx-auto mt-14 grid max-w-6xl gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.15 }}
            custom={0.12}
            className="relative overflow-hidden rounded-[30px] border border-zinc-800 bg-zinc-900/70 p-7 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8 lg:p-10"
          >
            ...
            <div className="relative z-10 mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
              <a
                href="https://wa.me/212723307462"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-3 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 px-8 py-4 text-sm font-semibold text-white shadow-[0_15px_40px_rgba(168,85,247,0.35)] transition-all duration-300 hover:-translate-y-[2px] hover:shadow-[0_25px_60px_rgba(168,85,247,0.45)]"
              >
              ...
              <a
                href="mailto:ismailmarkhi17@gmail.com"
                className="inline-flex items-center justify-center gap-2 text-sm font-medium text-zinc-400 transition hover:text-white"
              >
                <Mail size={16} />
                Or send an email
              </a>
            ...
            {contacts.map(
              ({
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`group relative overflow-hidden rounded-[24px] border border-zinc-800 bg-zinc-900/70 p-5 backdrop-blur-xl transition-all duration-500 hover:-translate-y-[4px] ${hoverBorder} ${hoverGlow}`}
                >
                  ...
                  <div className="relative z-10 flex items-center gap-4">
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-2xl border border-zinc-700 bg-zinc-800 transition duration-300 ${textColor}`}
                    >
                      <Icon size={20} />
                    </div>
